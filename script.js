...
document.getElementById('musicname').innerHTML = `${dataObject["recenttracks"]["track"][0]["name"]} <a href="${'https://open.spotify.com/search/' + dataObject["recenttracks"]["track"][0]["name"] + " " + dataObject["recenttracks"]["track"][0]["artist"]["#text"]}" id="iconms"><i style="color: white; padding-left: 3px;" class="fa-brands fa-spotify"></i></a><br>${dataObject["recenttracks"]["track"][0]["artist"]["#text"]}`
